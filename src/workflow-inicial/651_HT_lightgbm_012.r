...
PARAM$bo_lgb <- makeParamSet(
  ...
  makeIntegerParam("max_depht", lower = 7L, upper = 15L),
  makeNumericParam("bagging_fraction", lower = 0.0, upper = 1.0),
  makeIntegerParam("num_iterations", lower = 50, upper = 99999),
...
PARAM$bo_iteraciones <- 250 # iteraciones de la Optimizacion Bayesiana
