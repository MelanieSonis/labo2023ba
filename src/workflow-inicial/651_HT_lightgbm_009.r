...
PARAM$bo_lgb <- makeParamSet(
  ...
  makeIntegerParam("max_depht", lower = 7L, upper = 20L),
  makeNumericParam("bagging_fraction", lower = 0.0, upper = 1.0),
  makeIntegerParam("num_iterations", lower = 500, upper = 4000),
  makeIntegerParam("lambda_l1", lower = 0.0, upper = 9000.0),
  makeIntegerParam("lambda_l2", lower = 0.0, upper = 800.0),
  makeIntegerParam("bagging_freq", lower = 0L, upper = 13L),
  makeIntegerParam("min_gain_to_split", lower = 0L, upper = 5L),
  makeNumericParam("min_sum_hessian_in_leaf", lower = 0.0, upper = 200.0)
)
