...
dtrain$clase_binaria1 <- ifelse(dtrain$clase_ternaria %in% c("CONTINUA", "BAJA+1"), "neg", "pos")
dtrain$clase_ternaria <- NULL 
# genero el modelo,  aqui se construye el arbol
# quiero predecir clase_binaria1 a partir de el resto de las variables
modelo <- rpart(
