...
ksemilla_azar <- 200003 # cambiar por la primer semilla
...
archivo_log <- "HT321_001.txt"
archivo_log_cvs <- "HT321_001.cvs"
archivo_BO <- "HT321_001.RDATA"

# leo si ya existe el log
#  para retomar en caso que se se corte el programa
GLOBAL_iteracion <- 0

if (file.exists(archivo_log_cvs)) {
  tabla_log <- fread(archivo_log_cvs)
